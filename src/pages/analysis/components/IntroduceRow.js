  ...
  <Row gutter={24}>
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        footer={
          <Field
            label={<FormattedMessage id="analysis.analysis.day-sales" defaultMessage="Daily Sales" />}
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        footer={
          <Field
            label={<FormattedMessage id="analysis.analysis.day-visits" defaultMessage="Daily Visits" />}
